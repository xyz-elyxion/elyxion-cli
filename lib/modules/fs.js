...
const fs = {
  ...
  existsSync(path) {
    if (typeof globalThis.__elyxion_fs_exists === 'function') {
      return globalThis.__elyxion_fs_exists(path);
    }
  ...
  mkdirSync(path, options) {
    if (typeof globalThis.__elyxion_fs_mkdir === 'function') {
      globalThis.__elyxion_fs_mkdir(path);
    }
  },
  ...
  readdirSync(path, options) {
    if (typeof globalThis.__elyxion_fs_readdir === 'function') {
      return globalThis.__elyxion_fs_readdir(path);
    }
    return [];
  },
  ...
  readFileSync(path, options) {
    if (typeof globalThis.__elyxion_fs_readFileSync === 'function') {
      const result = globalThis.__elyxion_fs_readFileSync(path);
      if (result === undefined) {
  ...
  rmdirSync(path, options) {
    if (typeof globalThis.__elyxion_fs_rmdir === 'function') {
      globalThis.__elyxion_fs_rmdir(path);
    }
  },
  ...
  statSync(path, options) {
    if (typeof globalThis.__elyxion_fs_stat === 'function') {
      const result = globalThis.__elyxion_fs_stat(path);
      if (result === undefined) {
        throw new Error('ENOENT: no such file or directory, stat \'' + path + '\'');
      }
      return {
        isFile: function() { return result.isFile; },
  ...
  unlinkSync(path) {
    if (typeof globalThis.__elyxion_fs_unlink === 'function') {
      globalThis.__elyxion_fs_unlink(path);
    }
  },
  ...
  writeFileSync(path, data, options) {
    if (typeof globalThis.__elyxion_fs_writeFileSync === 'function') {
      globalThis.__elyxion_fs_writeFileSync(path, data);
      return;
    }
  },
